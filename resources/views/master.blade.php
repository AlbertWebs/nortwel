...
<html lang="en">
   <head>
      <title>Nortwel - embodying an unwavering commitment to provide exceptional services </title>
      <meta charset="utf-8">
      <!--[if IE]>
      <meta http-equiv="X-UA-Compatible" content="IE=edge">
      <![endif]-->
      <meta name="robots" content="index, follow" >
      <meta name="keywords" content="Nortwel - embodying an unwavering commitment to provide exceptional services" >
            ...
            <footer class="page-section pt-80 pb-50">
                <div class="container">
                   ...
                   <div class="footer-2-copy-cont clearfix">
                      ...
                      <!-- Copyright -->
                      <div class="left">
                         <a class="footer-2-copy" href="#home" target="_blank"> &copy; Copyright {{date('Y')}} FID-ELITE | All Rights Reserved</a>
                      </div>
                   </div>
                </div>
             </footer>
